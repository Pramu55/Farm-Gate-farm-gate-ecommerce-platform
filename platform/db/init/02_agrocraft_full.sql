-- Original AgroCraft.sql content. For initialization.
-- phpMyAdmin SQL Dump
-- version 4.9.0.1
...
-- NOTE: docker-entrypoint already selects database from 01_schema.sql

-- BEGIN Imported from /workspace/AgroCraft.sql
...
INSERT INTO `categories` (`cat_id`, `cat_title`) VALUES (1, 'Crops'), (2, 'Vegetables'), (3, 'Fruits');
...
(58, 3, 2, ' Raj Uday 234', 'Buyer', 8169193101, 10, 'paytm', 1234567890),
